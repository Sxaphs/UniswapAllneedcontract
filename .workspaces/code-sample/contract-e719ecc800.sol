...
import "@openzeppelin/contracts@4.8.1/token/ERC20/extensions/ERC20Snapshot.sol";
...
import "@openzeppelin/contracts@4.8.1/token/ERC20/extensions/ERC20FlashMint.sol";

contract TestUni2 is ERC20, ERC20Burnable, ERC20Snapshot, Ownable, Pausable, ERC20Permit, ERC20Votes, ERC20FlashMint {
    constructor() ERC20("TestUni2", "TUN2") ERC20Permit("TestUni2") {
